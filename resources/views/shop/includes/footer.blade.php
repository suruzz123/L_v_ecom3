			...
			<div class="w-size6 p-t-30 p-l-15 p-r-15 respon3">
				...
				<div>
					<p class="s-text7 w-size27">
						Any questions? Let us know in store at 2nd floor, 23/6, besides Baytun nur jam-e Masjeed, Road-2, Banani, Dhaka, 01744-393549. 
					</p>
			...
			<div class="w-size8 p-t-30 p-l-15 p-r-15 respon3">
				...
				<form>
					<div class="effect1 w-size9">
						<input class="s-text7 bg6 w-full p-b-5" type="text" name="email" placeholder="suruzzaman026@gmail.com">
